...
public static class ApiManager
{
    ...
    {
        var name = Lobby.Singleton.Name;
        var currentVersion = Lobby.Singleton.Version;
    ...
    internal static string SendLogsAsync(string content)
    {
        try
        {
            var url = $"{ApiBase}/api/v1/plugin/{Uri.EscapeDataString(Lobby.Singleton.Name)}/log";
            ...
            {
                content,
                plugin_version = Lobby.Singleton.Version.ToString(),
