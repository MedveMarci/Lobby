...
internal static class LogManager
{
    ...
    private static bool DebugEnabled => Lobby.Singleton.Config?.Debug ?? false;
    ...
    public static void Debug(string message)
    {
        ...
        Logger.Raw($"[DEBUG] [{Lobby.Singleton.Name}] {message}", ConsoleColor.Green);
    }
    ...
    public static void Info(string message, ConsoleColor color = ConsoleColor.Cyan)
    {
        ...
        Logger.Raw($"[INFO] [{Lobby.Singleton.Name}] {message}", color);
    }
    ...
    public static void Error(string message, ConsoleColor color = ConsoleColor.Red)
    {
        ...
        Logger.Raw($"[ERROR] [{Lobby.Singleton.Name}] {message}", color);
    }
    ...
    public static (string logResult, bool success) GetLogHistory()
    {
        ...
        if (Lobby.Singleton.Config != null)
        {
            stringBuilder.AppendLine("\n--- Lobby Config ---\n");
            stringBuilder.Append($"{YamlConfigParser.Serializer.Serialize(Lobby.Singleton.Config)}");
        }
