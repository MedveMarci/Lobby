...
public class RestrictionsHandler
{
    ...
    public void OnPlayerSearchingPickup(PlayerSearchingPickupEventArgs ev)
    {
        ev.IsAllowed = !IsLobby;
    }
    ...
    public void OnPlayerThrowingItem(PlayerThrowingItemEventArgs ev)
    {
        ev.IsAllowed = !IsLobby;
    }
